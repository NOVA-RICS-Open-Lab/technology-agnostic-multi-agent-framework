...
public:
    ...
    PingerAgent(const String& name, const String& ip, const tamaf::types::Address& regAddress) 
        : Agent(name.c_str(), tamaf::types::Address(ip, 4000), regAddress) {}
...
public:
    ...
    FSMTestAgent(const String& name, const String& ip, const tamaf::types::Address& regAddress) 
        : Agent(name.c_str(), tamaf::types::Address(ip, 4001), regAddress) {}
