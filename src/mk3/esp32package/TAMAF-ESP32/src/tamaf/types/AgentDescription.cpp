...
const AgentID& AgentDescription::getAgentId() const { return agentId; }
AgentID& AgentDescription::getAgentId() { return agentId; }
void AgentDescription::setAgentId(const AgentID& agentId) { this->agentId = agentId; }
void AgentDescription::setPort(int port) { this->agentId.setPort(port); }
void AgentDescription::setAddress(const Address& addr) { this->agentId.setAddress(addr); }

const std::vector<ServiceDescription>& AgentDescription::getServices() const { return services; }
std::vector<ServiceDescription>& AgentDescription::getServices() { return services; }
void AgentDescription::addService(const ServiceDescription& service) { services.push_back(service); }
void AgentDescription::clearServices() { services.clear(); }
